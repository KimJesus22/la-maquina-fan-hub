  ...
  return (
    <div className="flex flex-1 flex-col items-center justify-center gap-4">
      ...
      <div className="relative h-12 w-12">
        ...
        <div className="absolute inset-2 animate-spin rounded-full border-2 border-white/10 border-b-white/70" style={{ animationDirection: "reverse", animationDuration: "0.8s" }} />
      </div>
